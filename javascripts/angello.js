...
myModule.controller('StoriesCtrl', function($scope, $http, angelloModel, angelloHelper) {
    $scope.currentStory;
    ...
    $scope.createCurrentStory = function () {
        $scope.stories.push({title: "New story", description: "Piesu"});
    }
    ...
    $scope.login = function (user) {
        $http({method:'POST',url:'http://127.0.0.1:4000/login',data:$scope.user,headers:{'Content-Type':'application/x-www-form-urlencoded'}}).success(function (res) {
